...
import redgear.brewcraft.blocks.MetaTileMachine;
import redgear.brewcraft.blocks.MetaTileBottlers;
...
public class MachinePlugin implements IPlugin {
	...
	public static MetaTileMachine brewing;
	public static SimpleItem brewery;

	public static MetaTileMachine machine;
	public static SimpleItem sprayer;
	
	public static MetaTileBottlers bottlers;
	...
	public void preInit(ModUtils mod) {
		...
		brewing = new MetaTileMachine(Material.iron, "RedGear.Brewcraft.Brewery",
		...
		machine = new MetaTileMachine(Material.iron, "RedGear.Brewcraft.Machine",
				RenderingRegistry.getNextAvailableRenderId());
		...
		bottlers = new MetaTileBottlers(Material.piston, "RedGear.Brewcraft.Bottlers");
