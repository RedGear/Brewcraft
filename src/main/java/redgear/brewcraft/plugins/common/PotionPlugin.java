...
public class PotionPlugin implements IPlugin {
	...
	public void Init(ModUtils mod) {
		...
		if (Brewcraft.inst.getBoolean("Global", "Toggle Unused Vanilla Potions", "Toggle Mojang's unused potions.",
			...
			registry.addPotion("Blindness", Potion.blindness, 30, 0);
			registry.addPotion("BlindnessLong", Potion.blindness, 60, 0);
			registry.addPotion("BlindnessVeryLong", Potion.blindness, 120, 0);
			...
			registry.addPotion("HealthBoost", Potion.field_76434_w, 120, 0, true);
			registry.addPotion("HealthBoostII", Potion.field_76434_w, 60, 1, true);
			registry.addPotion("HealthBoostIII", Potion.field_76434_w, 30, 2, true);
			registry.addPotion("HealthBoostLong", Potion.field_76434_w, 240, 0, true);
			registry.addPotion("HealthBoostVeryLong", Potion.field_76434_w, 480, 0, true);
		...
		registry.addPotion("FireResistVeryLong", Potion.fireResistance, 960, 0);
